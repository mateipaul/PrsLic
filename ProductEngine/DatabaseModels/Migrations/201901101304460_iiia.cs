namespace DatabaseModels.Migrations
{
    ...
    public partial class iiia : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.IstoricCautari", t => t.Id_Cautare)
                .ForeignKey("dbo.Produs", t => t.Id_Produs)
                .Index(t => t.Id_Produs)
                .Index(t => t.Id_Cautare);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AparitieProdus", "Id_Produs", "dbo.Produs");
            DropForeignKey("dbo.AparitieProdus", "Id_Cautare", "dbo.IstoricCautari");
            ...
            DropIndex("dbo.AparitieProdus", new[] { "Id_Cautare" });
            DropIndex("dbo.AparitieProdus", new[] { "Id_Produs" });
